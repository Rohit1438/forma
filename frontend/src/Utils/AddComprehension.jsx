    ...
    try {
      ...
      let res = await axios.post(
        ...
        {  "questionType": "comprehension",
           "title": title, "answer":op2 ,"description":op1},
        { headers: { authorization: `Bearer ${token}` } }
      );
console.log(res)
res=await res.data
setquestions((pre) => [...pre,res]);
  ...
  return (
    <>
      ...
      >
        <img src="https://cdn-icons-png.flaticon.com/512/8653/8653313.png" style={{height:"50px"}} alt="" />
         {/* <svg
      ...
      >
        ...
        <AlertDialogContent >
          ...
          <AlertDialogHeader>Comprehension</AlertDialogHeader>
          <AlertDialogCloseButton />
          <AlertDialogBody>
            <FormControl>
